...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { description: @lecture.description, name: @lecture.name, short_name: @lecture.short_name, stcs_point: @lecture.stcs_point } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { description: @lecture.description, name: @lecture.name, short_name: @lecture.short_name, stcs_point: @lecture.stcs_point } }
